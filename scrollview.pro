...
UBUNTU_TRANSLATION_DOMAIN="scrollview.liu-xiao-guo"
...
aptest.commands = bash $$PWD/scrollview/tests/autopilot/run
aptest.depends  = sub-scrollview

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/scrollview/tests/unit
unittest.depends  = sub-scrollview
